...
public class Rotor {
    ...
    public int convertForward(int p) {
        return _permutation.wrap(_permutation.permute(setting() + p)-setting());
    ...
    public int convertBackward(int c) {
        return _permutation.wrap(_permutation.invert(setting() + c) - setting()); // FIXME - How do we invert the index E, taking into account my current position?
    }
