...
public class PermutationTest {
    ...
    public void checkForwardTransform() {
        ...
        perm = new Permutation("(" + UPPER_STRING + ")", UPPER); // FIXME - what string represents the Permutation for the above description?
    ...
    public void checkBackwardTransform() {
        String reverse = new StringBuffer(UPPER_STRING).reverse().toString();
    	// permutation which maps each character backward by one (e.g. B->A, A->Z)
        perm = new Permutation("(" + reverse +")", UPPER); // FIXME - what string represents the Permutation for the above description?
